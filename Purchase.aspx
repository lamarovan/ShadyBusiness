...
<asp:Content ID="Purchaser" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div  class="form-row rounded" style="background-color:gainsboro; width:100%;padding:15px;">
        <div class="form-group col-md-6">
            <label>Items</label>
            <asp:DropDownList class="form-control" ID="ddlItem" runat="server" DataSourceID="itemData" OnSelectedIndexChanged="ddlItem_SelectedIndexChanged" AutoPostBack="true" DataTextField="item_name" DataValueField="item_code"></asp:DropDownList>
        ...
        <div class="form-group col-md-6">
            ...
            <asp:DropDownList ID="ddlPurchaseUnit" runat="server"  class="form-control"></asp:DropDownList>
            </div>
    ...
    <div class="form-group">
        ...
        <asp:GridView ID="itemsGrid"  EmptyDataText="No records has been added." CssClass="table table-striped  table-bordered" runat="server" OnRowDeleting="itemsGrid_RowDeleting1" AutoGenerateDeleteButton="true" DataKeyNames="ID"></asp:GridView>
    </div>    
    <div>
